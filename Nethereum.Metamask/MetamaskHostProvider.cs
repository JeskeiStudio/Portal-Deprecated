    ...
    public class MetamaskHostProvider: IEthereumHostProvider
    {
        ...
        public async Task<string> EnableProviderAsync()
        {
            ...
            if (Enabled)
            {
                ...
                //
                // Use Sokol, later use Gnosis network
                // Call Subgraph to check if current address exists. If not, then sign a tx to create a user record with current address.
                // Table: Channel - OwnerAddress,  
